...
// macOS: ~/Library/Application Support/PenBoard/
// Windows: %APPDATA%\PenBoard\
// Linux: ~/.config/PenBoard/
...
// ---------------------------------------------------------------------------
// Port file for MCP sync discovery (~/.penboard/.port)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// File association: open .pb/.op files
// ---------------------------------------------------------------------------

/** Extract .pb/.op file path from command-line arguments. */
...
// macOS: open-file fires when user double-clicks a .pb/.op file
