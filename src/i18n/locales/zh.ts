...
const zh: TranslationKeys = {
  ...
  'variables.tokenColor': '颜色令牌',
  'variables.tokenSpacing': '间距令牌',
  'variables.tokenTypography': '字体令牌',
  'variables.tokenNumber': '数值令牌',
  ...
  'figma.autoLayout': 'PenBoard 自动布局',
  'figma.comingSoon': '即将推出',

  // ── Landing Page ──
  'landing.open': 'Pen',
  'landing.pencil': 'Board',
  'landing.tagline': '故事板设计工具。设计画面、连接流程、建模数据。',
