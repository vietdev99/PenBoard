...
const MODEL_PREFERENCE_STORAGE_KEY = 'penboard-ai-model-preference'
const CONCURRENCY_STORAGE_KEY = 'penboard-ai-concurrency'
const UI_PREFS_KEY = 'penboard-ai-ui-preferences'
